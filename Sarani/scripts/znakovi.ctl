...
{  
   ...
   {
	 case 0:
		args = portal_ugasen(iSign_Type_ID, sIP_addr);
       break;
     //normalni uslovi
     case 1:
     ...
     case 21:
       ...
       break;
     case 25:
       args = portal_klizavo_100(iSign_Type_ID, sIP_addr);
       break;
...
dyn_mixed portal_ugasen(int iSign_Type_ID, string sIP_addr)
{    
  dyn_mixed args; 
  args = portal_sign_arguments(iSign_Type_ID, sIP_addr,
                                0, //int Active,		                          			
                          			...
                          			"ТУНЕЛ'nl''nl''TIME''nl'", //string sText,
                                0, //int Active_2,
                                32, //int Bgr1_2,
                                32, //int Bgr2_2,
                                2, 0, //int Fn1_2, int Y1_2,
                                2, 13, //int Fn2_2, int Y2_2, 
                          			2, 26, //int Fn3_2, int Y3_2, 
                          			2, 0, 0, 8, //int Pict1_2, int Pict2_2, int Pict3_2, int Pict4_2, 
                          			"TUNNEL'nl''nl''TIME''nl'" //string sText_2
                                );								      
      DebugFTN("level1","portal_ugasen - args: ", args);
      return args;
}
...
dyn_mixed portal_klizavo_100(int iSign_Type_ID, string sIP_addr)
{
  dyn_mixed args;
  string sDateTime = "";
  int iTemp = 0;
  int Active = 1;		
      ...
      args = makeDynMixed(iSign_Type_ID, sIP_addr, 
                          ...
                          Pict1_2, Pict2_2, Pict3_2, Pict4_2,
                          sText_2);		
      DebugFTN("level1","portal_klizavo_100 - args: ", args);
      return args;
}
...
dyn_mixed portal_poledica_40(int iSign_Type_ID, string sIP_addr)
{
  ...
  int Active = 1;		
			...
			string sText = "МОГУЋА'nl'ПОЛЕДИЦА'nl''nl'";			
      ...
      int Active_2 = 1;		
			...
			string sText_2 = "POSSIBLE'nl'ICE'nl''nl'";
...
dyn_mixed portal_nezgoda_u_desnoj_traci_60(int iSign_Type_ID, string sIP_addr)
{
  ...
  int Active = 1;		
      ...
      int Active_2 = 1;		
			...
			int Xbgr2_2 = 136;
			int Ybgr2_2 = 0;			
			int Fn1_2 = 0; int Cl1_2 = 0; int Alig1_2 = 1; int MaxSp1_2 = 2; int Y1_2 = 1; int XL1_2 = 40; int XR1_2 = 135; 
			int Fn2_2 = 0; int Cl2_2 = 0; int Alig2_2 = 1; int MaxSp2_2 = 2; int Y2_2 = 27; int XL2_2 = 40; int XR2_2 = 135; 
			int Fn3_2 = 0; int Cl3_2 = 0; int Alig3_2 = 1; int MaxSp3_2 = 2; int Y3_2 = 500; int XL3_2 = 40; int XR3_2 = 135; 
...
dyn_mixed portal_nezgoda_u_lijevoj_traci_60(int iSign_Type_ID, string sIP_addr)
{
  ...
  int Active = 1;		
			...
			int Ybgr2 = 0;			
			int Fn1 = 2; int Cl1 = 0; int Alig1 = 1; int MaxSp1 = 2; int Y1 = 0; int XL1 = 40; int XR1 = 135; 
			int Fn2 = 2; int Cl2 = 0; int Alig2 = 1; int MaxSp2 = 2; int Y2 = 15; int XL2 = 40; int XR2 = 135; 
			int Fn3 = 2; int Cl3 = 0; int Alig3 = 1; int MaxSp3 = 2; int Y3 = 29; int XL3 = 40; int XR3 = 135; 
      ...
      int Active_2 = 1;		
			...
			int Xbgr2_2 = 136;
			int Ybgr2_2 = 0;			
			int Fn1_2 = 0; int Cl1_2 = 0; int Alig1_2 = 1; int MaxSp1_2 = 2; int Y1_2 = 4; int XL1_2 = 40; int XR1_2 = 135; 
			int Fn2_2 = 0; int Cl2_2 = 0; int Alig2_2 = 1; int MaxSp2_2 = 2; int Y2_2 = 24; int XL2_2 = 40; int XR2_2 = 135; 
			int Fn3_2 = 0; int Cl3_2 = 0; int Alig3_2 = 1; int MaxSp3_2 = 2; int Y3_2 = 500; int XL3_2 = 40; int XR3_2 = 135; 
