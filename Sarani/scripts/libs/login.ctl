...
afterLogin(string user, string password, string newLocale, int closeModules = 1, int iConfNum = 1) 
{
  ...
  string panel    = "vision/pvss", s;           // default panelName  to be opened after login
...
{
    strreplace( newLocale, "Srpski (latinica)", "hr_HR.utf8");
    strreplace( newLocale, "Српски (ћирилица)", "ru_RU.utf8");
