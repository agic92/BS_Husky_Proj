...
string msName = "MS2"; // ime Meteostanice
const string meteostanica = "10.101.0.217"; // IP meteostanice
const int msPort = 8000; // Port meteostanice, defaultni je 8000
const string host = "127.0.0.1"; // Računar na kojem je Adapter 
const int port = 6205; // Port adapter servera

const string rs = "4097"; //road sensor id
const string rs2 ="4098"; //second road sensor id
...
void updatePodataka() {
  //ako nije server aktivan ne ocitavaj meteostanicu
  if(!isReduActive())
    return;
